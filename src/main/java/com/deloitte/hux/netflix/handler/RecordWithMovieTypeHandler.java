...
public class RecordWithMovieTypeHandler implements APIRequest {
	
	private final String movieType;
	
	public RecordWithMovieTypeHandler(String movieType) {
	...
	public ResponseEntity<?> doProcess() throws Exception {
		...
		List<String>recordList = NetflixDataOperations.listedHorrorMovies(br, keyToIndexMap, movieType);
		br.close();
